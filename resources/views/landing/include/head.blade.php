...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('') }}css/elegant-font.css" type="text/css" media="all" />
    <link rel="stylesheet" href="{{ asset('') }}css/style.css" type="text/css" media="all" />
    <link rel="stylesheet" href="{{ asset('') }}css/page-builder.css" type="text/css" media="all" />
    <link rel="stylesheet" href="{{ asset('') }}plugins/revslider/public/assets/css/rs6.css" type="text/css"
        media="all" />
